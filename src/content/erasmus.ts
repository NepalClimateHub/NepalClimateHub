...
export const aboutData = {
  ...
  paragraphs: [
    ...
    "Last year, 915 students from all 7 provinces showed up for edition one. This year, we're going bigger and better.",
  ],
  quote:
...
export const whatYouWillLearnData = {
  ...
  footer:
    "Many of these are also required for other scholarships and universities, so regardless, you'll be prepared for scholarships across the world!",
};
